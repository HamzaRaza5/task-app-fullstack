...
import Task from "../assets/logo.png";
import custom_axios from "../axios/AxiosSetup";
import { toast } from "react-toastify";

const SignUp = () => {
  let navigate = useNavigate();
  let firstName: any = React.useState();
  let lastName: any = React.useState();
  let password: any = React.useState();
  let confirmPassword: any = React.useState();
  let email: any = React.useState();
        ...
        <div className="flex justify-center px-6 my-12">
          ...
          <div className="w-full  border-black xl:w-3/4 lg:w-11/12 flex">
            ...
            <div className="w-full   h-full bg-white hidden p-12  lg:block lg:w-5/12 bg-cover rounded-l-lg ">
              <img src={Task} className={"h-full  w-full "} />
            </div>
            {/* Col */}
